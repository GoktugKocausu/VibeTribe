  ...
  useEffect(() => {
    const loadEventDetails = async () => {
      try {
        ...
        setIsAttending(attendeesData.some(attendee => attendee.username === currentUser?.username));
    ...
    <Box sx={{ bgcolor: '#F8FAFC', minHeight: '100vh', py: 6 }}>
      <Container maxWidth="lg">
        ...
        >
          <Box
            component="img"
            src={event.imageUrl ? `http://localhost:8080${event.imageUrl}` : 'https://source.unsplash.com/random?event'}
            alt={event.title}
            sx={{
              width: '100%',
              height: '400px',
          ...
          <Grid item xs={12} md={4}>
            ...
            <Paper sx={{ p: 3, borderRadius: 2, mb: 3 }}>
              ...
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 3 }}>
                ...
                <Typography variant="body2" color="text.secondary">
                  {event?.maxAttendees - event?.currentAttendees} kişilik yer kaldı
                </Typography>
              </Box>
              ...
              {!isEventCreator ? (
                <Button
                  ...
                  disabled={event?.currentAttendees >= event?.maxAttendees && !isAttending}
                  sx={{
                ...
                >
                  {isAttending ? 'Ayrıl' : event?.currentAttendees >= event?.maxAttendees ? 'Etkinlik Dolu' : 'Katıl'}
                </Button>
              ) : (
              ...
              <Stack spacing={3}>
                ...
                <LocalizationProvider dateAdapter={AdapterDayjs} adapterLocale="tr">
                  <DateTimePicker
                    ...
                    onChange={(newValue) => setEditFormData({ ...editFormData, startTime: newValue })}
                  ...
                  <DateTimePicker
                    ...
                    onChange={(newValue) => setEditFormData({ ...editFormData, endTime: newValue })}
                    format="DD/MM/YYYY HH:mm"
                  />
                ...
                <TextField
                  ...
                  onChange={(e) => setEditFormData({ ...editFormData, maxAttendees: e.target.value })}
                />
